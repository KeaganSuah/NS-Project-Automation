...
from parade_state_function import submit, insert, delete_by_name, search, display_attendance, display_unresponsive, \
    ...
    ranking, branches_string, dropdown_branch, generate_branch_not_submitted, branches_uncompleted, status_branch
...
@views.route('/rollcall-home', methods=["GET", "POST"])
def index():
